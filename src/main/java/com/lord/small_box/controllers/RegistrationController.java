...
public class RegistrationController {
	...
	@PutMapping("/update")
	ResponseEntity<AppUserRegistrationDto> update(@RequestBody AppUserUpdatedDto userDto,@RequestParam("authority")String authority){
		AppUserRegistrationDto updatedUserDto = authorizationService.updateUser(userDto, authority);
		return new ResponseEntity<AppUserRegistrationDto>(updatedUserDto,HttpStatus.OK);
	}
